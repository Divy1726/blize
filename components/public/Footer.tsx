          ...
          {/* Brand Column */}
            ...
            <div className="mb-8 flex items-center gap-4">
              <a
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full text-[#9FB0C7] transition-all duration-300 hover:bg-white/10 hover:text-white hover:scale-105"
                aria-label="LinkedIn"
              >
      ...
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/terms" className="text-sm text-[#70829C] transition-colors hover:text-white">
              Terms
            </Link>
            <Link href="/cookies" className="text-sm text-[#70829C] transition-colors hover:text-white">
              Cookies
            </Link>
          </div>
        </div>
